...
- (void)setupScrollView
{
    ...
    for (int i = 0; i < self.imageCount; i++) {
        ...
        // 长按图片
          UILongPressGestureRecognizer *longSingleTap = [[UILongPressGestureRecognizer alloc] initWithTarget:self action:@selector(photoLongClick:)];
        longSingleTap.numberOfTapsRequired = 0;
        longSingleTap.minimumPressDuration = 0.5;
        [imageView addGestureRecognizer:longSingleTap];
...
-(void)photoLongClick:(UILongPressGestureRecognizer *)recognizer{
    ...
    if (recognizer.state == UIGestureRecognizerStateBegan) {
        ...
        NSURL *imageUrl = [self highQualityImageURLForIndex:recognizer.view.tag];
//        NSString *urlString_ = imageUrl.absoluteString;
    }
}
...
- (void)showFirstImage
{
    ...
    //修正 iphone 5 刷机报错的BUG  [_scrollView.subviews[self.currentImageIndex] bounds]
